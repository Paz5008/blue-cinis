        ...
        >
            ...
            <input
                ...
                className="w-full pl-12 pr-10 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-white/40 
                           focus:outline-none focus:border-indigo-500/50 focus:bg-white/8 focus:ring-2 focus:ring-indigo-500/20
                           transition-all duration-200"
                aria-label="Rechercher un évènement par titre ou lieu"
            />
            ...
            {value && (
                <m.button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-white/40 hover:text-white/70 transition-colors
                               focus:outline-none focus:ring-2 focus:ring-indigo-500/50 rounded-full"
